...
class EditContentViewModel(val dao: TruthOrDareGameDatabaseDao, application: Application, contentID: Int, contentString: String, contentType: ContentType) : AndroidViewModel(application) {
